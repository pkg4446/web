...
function getdata(send_data, device){
    ...
    fetch("//yc.beetopia.kro.kr"+"/hive/config", {
        method: 'POST',
        headers: {
...
function fetch_equipment() {
    ...
    fetch("//yc.beetopia.kro.kr"+"/hive/list", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function fetch_user_info() {
    ...
    fetch("//yc.beetopia.kro.kr"+"/user/info", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
    ...
    if(view_locker){
        Swal.fire({
            ...
            if (result.isConfirmed){
                ...
                fetch("//yc.beetopia.kro.kr"+"/hive/disconnect", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
function fetch_device_rename(device_id,device_name) {
    if(view_locker){
        ...
        fetch("//yc.beetopia.kro.kr"+"/hive/devicerename", {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
...
function fetch_equipment_heater(device_id,func,value) {
    ...
    fetch("//yc.beetopia.kro.kr"+"/hive/heater", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
